...
def nodeGeneration2(txt, costs, node, depth, maxdepth, branching_factor, first):
...
def TreeGen(maxdepth, branching_factor, complexity):
    ...
    if complexity == 2:
        string,costs,first = nodeGeneration2(ret,costs,"node",0,maxdepth, branching_factor,0)
    return string,costs
